...
<div class="row justify-content-center" style="margin-top:-2em;">
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label for="code" class="control-label">University ID/Code</label>
		...
		<div class="card rounded-0 shadow">
			<div class="card-header">
				<h5 class="card-title font-weight-bolder">Hall Information</h5>
				...
				<div class="container-fluid">
					<fieldset class="border-bottom">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label for="dorm" class="control-label">Hall</label>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="form-group">
									<label for="rate" class="control-label">Monthly Meal Fee</label>
